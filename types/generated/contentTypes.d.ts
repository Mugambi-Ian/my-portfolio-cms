...
export interface ApiResumeResume extends Schema.SingleType {
  ...
  attributes: {
    ...
    references: Attribute.Component<'references.references', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    awards: Attribute.Component<'awards.awards', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    education: Attribute.Component<'education.education'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiRoleDutyRoleDuty extends Schema.CollectionType {
  collectionName: 'role_duties';
  info: {
    singularName: 'role-duty';
    pluralName: 'role-duties';
    displayName: 'DeparmentRoles';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::role-duty.role-duty': ApiRoleDutyRoleDuty;
